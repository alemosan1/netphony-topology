...
public class Capacity   {
  ...
  public enum PacketBwProfileTypeEnum {
    ...
    @JsonCreator
    public static PacketBwProfileTypeEnum fromValue(String text) {
      for (PacketBwProfileTypeEnum b : PacketBwProfileTypeEnum.values()) {
  ...
  public enum TotalSizeEnum {
    ...
    @JsonCreator
    public static TotalSizeEnum fromValue(String text) {
      for (TotalSizeEnum b : TotalSizeEnum.values()) {
        if (String.valueOf(b.value).equals(text)) {
          return b;
        }
      }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.committedBurstSize, capacity.committedBurstSize) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(committedBurstSize, peakBurstSize, peakInformationRate, couplingFlag, colorAware, committedInformationRate, packetBwProfileType, totalSize);
  }
